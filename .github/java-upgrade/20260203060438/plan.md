...
## Project Information
- **Project path**: /Users/emilianotoulouze/vellbeing-os 2
- **Working branch**: appmod/java-upgrade-20260203060438
...
- **Source JDK path (Java 17)**: /Users/emilianotoulouze/.jdk/jdk-17.0.16/jdk-17.0.16+8/Contents/Home/bin
- **Target JDK path (Java 21)**: <span style="color:red"><to be installed, or specify the path here></span>
- **Build tool type**: Maven
- **Build tool path**: /opt/homebrew/Cellar/maven/3.9.12/bin
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20260203060438`.
